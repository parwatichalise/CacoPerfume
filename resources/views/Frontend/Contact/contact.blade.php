...
@section('content')
    ...
    <div class="py-5 mb-5 container-fluid page-header wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5 text-center">
            <h1 class="mb-4 display-2 text-dark animated slideInDown">Contact Us</h1>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <form>
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <button class="px-5 py-3 btn btn-primary rounded-pill" type="submit">Send Message</button>
                            </div>
                        </div>
                    </form>
                </div>
