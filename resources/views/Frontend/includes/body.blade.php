    ...
    <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="w-100" src="{{asset('Frontend/dist/img/carousel-1.jpg')}}" alt="Image">
                <div class="carousel-caption">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="text-center col-lg-7">
                                <p class="text-white fs-4 animated zoomIn">Welcome to <strong class="text-dark">TEA House</strong></p>
            ...
            <div class="carousel-item">
                <img class="w-100" src="{{asset('Frontend/dist/img/carousel-2.jpg')}}" alt="Image">
                <div class="carousel-caption">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="text-center col-lg-7">
        ...
        <div class="row g-5">
            <div class="col-lg-6">
                <div class="row g-3">
                    <div class="col-6 text-end">
                        <img class="mb-3 bg-white img-fluid w-100 wow fadeIn" data-wow-delay="0.1s" src="{{asset('Frontend/dist/img/about-1.jpg')}}" alt="">
                        <img class="bg-white img-fluid w-50 wow fadeIn" data-wow-delay="0.2s" src="{{asset('Frontend/dist/img/about-3.jpg')}}" alt="">
                    </div>
                    <div class="col-6">
                        <img class="mb-3 bg-white img-fluid w-50 wow fadeIn" data-wow-delay="0.3s" src="{{asset('Frontend/dist/img/about-4.jpg')}}" alt="">
                        <img class="bg-white img-fluid w-100 wow fadeIn" data-wow-delay="0.4s" src="{{asset('Frontend/dist/img/about-2.jpg')}}" alt="">
                    </div>
                </div>
            </div>
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                ...
                <div class="mb-4 row g-3">
                    <div class="col-sm-4">
                        <img class="bg-white img-fluid w-100" src="{{asset('Frontend/dist/img/about-5.jpg')}}" alt="">
                    </div>
                    <div class="col-sm-8">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-sm-4">
                        <img class="bg-white img-fluid w-100" src="{{asset('Frontend/dist/img/about-6.jpg')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row g-0">
            <div class="py-5 col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                <div class="py-5">
                    <h1 class="mb-4 display-6">Tea is a drink of <span class="text-white">health</span> and <span class="text-white">beauty</span></h1>
                    <h5 class="mb-5 text-white fw-normal lh-base fst-italic">Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit</h5>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="text-center store-item position-relative">
                    ...
                    <div class="store-overlay">
                        <a href="" class="px-4 py-2 m-2 btn btn-primary rounded-pill">More Detail <i class="fa fa-arrow-right ms-2"></i></a>
                        <a href="" class="px-4 py-2 m-2 btn btn-dark rounded-pill">Add to Cart <i class="fa fa-cart-plus ms-2"></i></a>
                    </div>
                </div>
            </div>
        ...
        <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.5s">
            <div class="p-4 testimonial-item p-lg-5">
                ...
                <div class="d-flex align-items-center justify-content-center">
                    <img class="flex-shrink-0 img-fluid" src="{{asset('Frontend/dist/img/testimonial-1.jpg')}}" alt="">
            ...
            <div class="p-4 testimonial-item p-lg-5">
                <p class="mb-4">Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo</p>
                <div class="d-flex align-items-center justify-content-center">
                    <img class="flex-shrink-0 img-fluid" src="{{asset('Frontend/dist/img/testimonial-2.jpg')}}" alt="">
                    <div class="text-start ms-3">
                        <h5>Client Name</h5>
                        <span class="text-primary">Profession</span>
                    </div>
            ...
            <div class="p-4 testimonial-item p-lg-5">
                <p class="mb-4">Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo</p>
                <div class="d-flex align-items-center justify-content-center">
                    <img class="flex-shrink-0 img-fluid" src="{{asset('Frontend/dist/img/testimonial-3.jpg')}}" alt="">
                    <div class="text-start ms-3">
                        <h5>Client Name</h5>
                        <span class="text-primary">Profession</span>
                    </div>
...
<div class="py-5 container-xxl contact">
    <div class="container">
        ...
        <div class="row justify-content-center wow fadeInUp" data-wow-delay="0.1s">
            <div class="col-lg-8">
                <p class="mb-5 text-center">Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo</p>
                <div class="row g-5">
